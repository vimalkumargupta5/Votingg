...
public class GoogleMapsActivity extends FragmentActivity implements
    ...
    public void onClick(View view){
        String pollingBooth = "pollingBooth";
        ...
        switch (view.getId())
        {
            case R.id.search_address:
                ...
                break;
            case R.id.centers_nearby:
                mMap.clear();
                String url = getUrl(latitude, longitude, pollingBooth);
                transferData[0] = mMap;
                transferData[1] = url;
                getNearbyPlaces.execute(transferData);
                Toast.makeText(this, "Searching Nearby Polling Booths..", Toast.LENGTH_SHORT).show();
                Toast.makeText(this, "Showing Nearby Polling Booths..", Toast.LENGTH_SHORT).show();
                break;
        }
    }
    private String getUrl(double latitude, double longitude, String nearbyPlace){
        ...
        googleURL.append("&key=" + "AIzaSyBvOpHlIpGCgb6lowxWzfmWMxnUdF_vk6g");
