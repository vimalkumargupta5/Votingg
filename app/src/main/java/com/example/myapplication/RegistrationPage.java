...
public class RegistrationPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("VotersRequest");
    ...
    public void addVoters(){
        ...
        if(!TextUtils.isEmpty(fullName) && !TextUtils.isEmpty(fatherName) && !TextUtils.isEmpty(uniqueId) && !TextUtils.isEmpty(mobileNo) && !TextUtils.isEmpty(dateBirth) && !TextUtils.isEmpty(emailVoter) && !TextUtils.isEmpty(addressLineOne) && !TextUtils.isEmpty(addressLineTwo) && !TextUtils.isEmpty(stateVoter) && !TextUtils.isEmpty(districtVoter) && !TextUtils.isEmpty(postalCode)){
            ...
            VoterRegistration voterRegistration = new VoterRegistration(id, fullName, fatherName,uniqueId,mobileNo,dateBirth, emailVoter, addressLineOne, addressLineTwo, stateVoter, districtVoter, postalCode, Gender);
            databaseReference.child(id).setValue(voterRegistration);
            ...
            Toast.makeText(RegistrationPage.this, "Please Fill Every Fields!", Toast.LENGTH_LONG).show();
        }
